...
- Embedding Layer Representation: 32 (los embeddings de texto se proyectan a 32 dimensiones para realizar early fusion con las imágenes mediante la multiplicación de ambas modalidades).
