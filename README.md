...
- Dado el tamaño reducido del conjunto de datos, se priorizó el uso de una arquitectura ligera que facilitara el análisis de los embeddings generados y la aplicación de técnicas de interpretabilidad (XAI).
