...
| 16 --> 32 (MaxPool2D+ReLU) | 64                 | 64                 | - Seed fija <br> - Sí Class Weight <br> - Multiplicación de features (Fusion)                       | 0.79                | Se equivoca en detectar las formas de las figuras: circle [0], rectangle [7], triangle [9] (3/12). --> Mejoró respecto al anterior.                                                                                                                  |
