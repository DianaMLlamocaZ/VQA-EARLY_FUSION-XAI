...
- Asimismo, también se pueden visualizar los *embeddings* de texto en un espacio de dos dimensiones con el objetivo de graficar la proximidad entre preguntas con temas similares y distintos.
