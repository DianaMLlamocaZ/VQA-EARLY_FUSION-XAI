...
class ModeloVQA_CW_LN_BoW(torch.nn.Module):
    def __init__(self,vocab_length,num_clases):
        super().__init__()

        #CNN: Visual Feature Embedding
        self.vc1=torch.nn.Conv2d(in_channels=3,out_channels=32,kernel_size=3)    
        self.vc2=torch.nn.Conv2d(in_channels=32,out_channels=32,kernel_size=3)
    ...
    def forward(self,image_tensor,question_tensor):
        ...
        join_embeddings=layer_norm_img*layer_norm_bow    
